...
<div class="mx-25">
  <div class="flex justify-end-safe mb-8">
    <NavigationMenu.Root viewport={false}>
      <NavigationMenu.List>
        ...
        <NavigationMenu.Item>
          <NavigationMenu.Link>
            {#snippet child()}
              <a href="/research" class={navigationMenuTriggerStyle()}>Research</a>
            {/snippet}
          </NavigationMenu.Link>
        </NavigationMenu.Item>
        ...
        <NavigationMenu.Item>
          <NavigationMenu.Link>
            {#snippet child()}
              <a href="/achievements" class={navigationMenuTriggerStyle()}>Achievements</a>
            {/snippet}
          </NavigationMenu.Link>
        </NavigationMenu.Item>
